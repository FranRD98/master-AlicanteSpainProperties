...
class AcumbamailAPI {
    ...
    **/
    ...
    /** getCampaignLinks
        Parameters:
            campaign_id = Identificador de la campaña de la que quieres obtener la información
        Example:
            getCampaignLinks("1000")
    **/

    public function getCampaignLinks($campaign_id){
        $request = "getCampaignLinks";
        $data = array(
            'campaign_id' => $campaign_id
        );
        return $this->callAPI($request, $data);
    ...
    /** searchSubscriber
        ...
        Example:
            searchSubscriber("email")
    **/

    public function searchSubscriber($subscriber){
        $request = "searchSubscriber";
        $data = array(
    ...
    **/
    public function sendOne($from, $to, $body, $subject, $cco = '', $category='') {
        $request = "sendOne";
