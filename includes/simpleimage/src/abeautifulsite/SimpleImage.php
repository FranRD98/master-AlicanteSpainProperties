...
class SimpleImage {
    ...
    public function __destruct() {
        if (isset($this->image)) {
            ...
            } elseif (is_resource($this->image) && get_resource_type($this->image) === 'gd') {
    ...
    function resize($width, $height) {
        ...
        $new = imagecreatetruecolor(round($width), round($height));
        ...
        // Resize
        imagecopyresampled($new, $this->image, 0, 0, 0, 0, round($width), round($height), $this->width, $this->height);
