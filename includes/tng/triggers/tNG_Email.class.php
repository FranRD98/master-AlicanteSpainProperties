...
class tNG_Email {
	 ...
	 * @access public
	 */
	function __construct($tNG)
	{
		global $smtpUrl, $smtpPort, $smtpUser, $smtpPass;
		...
		/*
		if(!isset($GLOBALS['tNG_email_host'])) $GLOBALS['tNG_email_host'] = '';
		if(!isset($GLOBALS['tNG_email_port'])) $GLOBALS['tNG_email_port'] = '';
		if(!isset($GLOBALS['tNG_email_user'])) $GLOBALS['tNG_email_user'] = '';
		if(!isset($GLOBALS['tNG_email_password'])) $GLOBALS['tNG_email_password'] = '';
		if(!isset($GLOBALS['tNG_email_defaultFrom'])) $GLOBALS['tNG_email_defaultFrom'] = '';
		*/
		
		if(!isset($GLOBALS['tNG_email_host'])) $GLOBALS['tNG_email_host'] = $smtpUrl;
		if(!isset($GLOBALS['tNG_email_port'])) $GLOBALS['tNG_email_port'] = $smtpPort;
		if(!isset($GLOBALS['tNG_email_user'])) $GLOBALS['tNG_email_user'] = $smtpUser;
		if(!isset($GLOBALS['tNG_email_password'])) $GLOBALS['tNG_email_password'] = $smtpPass;
		if(!isset($GLOBALS['tNG_email_defaultFrom'])) $GLOBALS['tNG_email_defaultFrom'] = $smtpUser;
	...
	function getUseSavedData()
	{
		if (!isset($this->useSavedData)) {
			$typeTra = null;
			if(isset($this->tNG))
				$typeTra = $this->tNG->getTransactionType();
			if ( isset($typeTra) && $typeTra=='_delete' || $typeTra=='_multipleDelete' ) {
