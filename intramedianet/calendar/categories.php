...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-calendar-lines"></i> <?php echo __('Categorías'); ?></h4>
                        ...
                        <table class="display table table-bordered align-middle" id="records-tables" width="100%">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th><?php __('Mostrar en reporte'); ?></th>
                                    <th><?php __('Color'); ?></th>
                                    <th id="actions"></th>
                                </tr>
                                <tr>
                                    <td><input type="text" name="<?php echo 'category_es_ct'; ?>" id="<?php echo 'category_es_ct'; ?>" class="form-control form-control-sm"></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
    ...
    <script src="/intramedianet/calendar/_js/categories-list.js" type="text/javascript"></script>
