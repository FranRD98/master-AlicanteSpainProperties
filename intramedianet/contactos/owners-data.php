...
?><?php
   ...
   */
  $aColumns = array( 'nombre_cnt', 'apellidos_cnt', 'email1_cnt', 'email2_cnt', 'email3_cnt', 'telefono1_cnt', 'telefono2_cnt', 'telefono3_cnt', 'referencia_cnt', 'cif_cnt', 'id_cnt' );
    ...
    if ( isset($_GET['bSearchable_'.$i]) && $_GET['bSearchable_'.$i] == "true" && $_GET['sSearch_'.$i] != '' )
    {
      ...
      if($aColumns[$i] == 'fecha_alta_pro') {
        ...
        if ($aColumns[$i] == 'status_pro') {
            ...
            $sWhere .= "(SELECT category_".$lang_adm."_sts  FROM contactos_states WHERE id_sts = status_pro) LIKE '%".mysqli_real_escape_string($gaSql['link'],$_GET['sSearch_'.$i])."%' ";
