...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-id-card-clip"></i> <?php echo __('Contactos'); ?></h4>
                        ...
                        <table class="display table table-bordered align-middle" id="records-tables" width="100%">
                            <thead class="table-light">
                                <tr class="align-top">
                                    ...
                                    <th><?php __('Referencia'); ?> <?php __('Empresa'); ?></th>
                                    <th><?php __('CIF'); ?></th>
                                    <th id="actions"></th>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="email2_pro" id="email2_pro" class="form-control form-control-sm"></td>
                                    <td><input type="text" name="email3_pro" id="email3_pro" class="form-control form-control-sm"></td>
                                    ...
                                    <td><input type="text" name="telefono_movil2_pro" id="telefono_movil2_pro" class="form-control form-control-sm"></td>
    ...
    <script src="_js/owners-list.js" type="text/javascript"></script>
