...
$query_rsMax ="SELECT MAX(order_fil) + 1  as max FROM news_files WHERE news_fil = '".$_GET['id_nws']."'";
...
$row_rsMax = mysqli_fetch_assoc($rsMax);
  ...
  $query_rsUserTrad = "INSERT INTO  `news_files` SET
`news_fil`  = '".$_GET['id_nws']."',
`file_fil` = '".$fileName."',
