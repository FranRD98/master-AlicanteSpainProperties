...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-newspaper"></i> <?php echo __('Eventos'); ?></h4>
                        ...
                        <table class="display table table-bordered align-middle" id="records-tables" width="100%">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th><?php __('Evento Finalizado'); ?></th>
                                    <th><?php __('Fecha'); ?></th>
                                    <th id="actions"></th>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="hidden" name="finished_nws" id="finished_nws">
                                        <select name="finished_nws_sel" id="finished_nws_sel" class="form-select form-select-sm">
                                            <option value=""><?php __('Todos'); ?></option>
                                            <option value="<?php __('Sí'); ?>"><?php __('Sí'); ?></option>
                                            <option value="<?php __('No'); ?>"><?php __('No'); ?></option>
                                        </select>
    ...
    <script src="/intramedianet/events/_js/news-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
