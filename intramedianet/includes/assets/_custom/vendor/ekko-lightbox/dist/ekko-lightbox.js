...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    header = '<div class="modal-header bg-primary"' + (this.options.title || this.options.always_show_close ? '' : ' style="display:none"') + '><h5 class="modal-title">' + (this.options.title || "&nbsp;") + '</h5><button type="button" class="btn-close bg-white mb-2" data-bs-dismiss="modal" aria-label="Close"> </button></div>';
