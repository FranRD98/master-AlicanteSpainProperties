...
?>
 <?php if($totalRows_rsImagenes >=  1) { ?>
                      ...
                      <?php do { ?>
                      <li class="pull-left" id="order_<?php echo $row_rsImagenes['id_img'] ?>" data-id="order_<?php echo $row_rsImagenes['id_img'] ?>">
...
//      update : function () {
//    var order = $('.listimg').sortable('serialize');
//    $.get("images_order.php?"+order, function(data) {
//      //alert(data);
//    });
//    }
// }).disableSelection();
