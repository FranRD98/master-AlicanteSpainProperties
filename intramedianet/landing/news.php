...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-memo-circle-check"></i> <?php echo __('Landing Pages'); ?></h4>
    ...
    <script src="/intramedianet/landing/_js/landings-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
