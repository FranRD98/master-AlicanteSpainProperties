            ...
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex">
                    <div class="flex-grow-1 oveflow-hidden">
                        <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-phone"></i> <?php echo __('Llamadas - Propietarios'); ?></h4>
                    </div>
                    <div class="flex-shrink-0 ms-2 d-none d-md-flex">
                        <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" href="clients.php" role="tab" aria-selected="true">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" href="owners.php" role="tab" aria-selected="false" tabindex="-1">
