...
$listas = $MailChimp->get('lists/' . $mailchimpIdListaPrincipal . '/segments/' . $_GET['id'], array(
    // 'sort_field' => 'web'
));
...
if ($_POST['list-name'] != '' ) {
    $MailChimp = new MailChimp($keyMailchimp);
    $result = $MailChimp->patch('lists/' . $mailchimpIdListaPrincipal . '/segments/' . $_GET['id'], array(
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title"><?php __('Edit list'); ?>: <?php echo $_GET['id'] ?></h3>
                </div>
