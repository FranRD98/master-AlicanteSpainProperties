...
$listas = $MailChimp->get('lists/' . $mailchimpIdListaPrincipal . '/segments', array(
    'count' => 100,
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered dataTable" id="records-tables" width="100%">
        				...
        				<tbody>
        					<?php foreach ($listas['segments'] as $key => $value) { ?>
                                <?php if ($value['id'] != '19e6bae365' && $value['id'] != '5c3867e968' && $value['id'] != 'cb3d62d8b9'): ?>
                					<tr>
                                        <td ><?php echo $value['id'] ?></td>
                						<td ><?php echo $value['name'] ?></td>
                						<td ><?php echo number_format($value['member_count'], 0, ',', '.'); ?></td>
                						<td class="actions">
                                            <a href="segments-edit.php?id=<?php echo $value['id'] ?>&KT_back=1" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>
                                            <a href="segments-delete.php?id=<?php echo $value['id'] ?>" class="btn btn-danger btn-sm delrow"><i class="fa fa-trash-o"></i></a>
