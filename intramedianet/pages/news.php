...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-memo"></i> <?php echo __('Páginas'); ?></h4>
    ...
    <script src="/intramedianet/pages/_js/pages-list.js" type="text/javascript"></script>
