...
if( isset($_GET['b_orientacion_cli']) && $_GET['b_orientacion_cli'] != '' ){
  ...
  $ocultos = '';
  if( isset($_GET['b_ocultos_cli']) && $_GET['b_ocultos_cli'][0] != '' ){
      $ocultos = array();
  ...
  $dirr = '';
  if( isset($_GET['b_direcc_cli']) && $_GET['b_direcc_cli'] != '' ){
      $dirr = "AND direccion_prop LIKE '%" . $_GET['b_direcc_cli']."%'";
  }

  $urb = '';
  if( isset($_GET['b_urb_cli']) && $_GET['b_urb_cli'] != '' ){
      $urb = "AND urbanizacion_prop LIKE '%" . $_GET['b_urb_cli']."%'";
  }
  ...
  $gargg = '';
  if( isset($_GET['b_garaje_cli']) && $_GET['b_garaje_cli'] != '' ){
      $gargg = "AND parking_prop LIKE '%" . $_GET['b_garaje_cli']."%'";
  }

  $vismarr = '';
  if( isset($_GET['b_vistasmar_cli']) && $_GET['b_vistasmar_cli'] != '' ){
      $vismarr = "AND vistas_mar_prop LIKE '%" . $_GET['b_vistasmar_cli']."%'";
  }
...
//     $_GET['b_beds_cli'] == '' &&
//     isset($_GET['or']) && $_GET['or'] == '' &&
//     $_GET['b_orientacion_cli'] == '' &&
//     $_GET['favs'] == '' &&
//     $_GET['b_baths_cli'] == ''  &&
...
//     !isset($_GET['b_costa_cli']) &&
//     !isset($_GET['b_loc4_cli'])  &&
//     !isset($_GET['b_opciones_cli'])  &&
//     !isset($_GET['b_opciones2_cli'])  &&
//     $_GET['nw'] == '' &&
//     $_GET['ven'] == '' && $_GET['alq'] == '' && $_GET['res'] == ''  && $_GET['rp'] == '' && $_GET['cs'] == '' && $_GET['sw'] == '' && $_GET['ep'] == '' && $_GET['po'] == '' && $_GET['rps'] == ''  && $_GET['direccion'] == ''  && $_GET['m2ut'] == ''  && $_GET['m2pl'] == '' && $_GET['b_direcc_cli'] == '' && $_GET['b_urb_cli'] == '' && $_GET['b_piscina_cli'] == '' && $_GET['b_garaje_cli'] == '' && $_GET['b_vistasmar_cli'] == '' && $_GET['b_obranueva_cli'] == '' && $_GET['b_m2_desde_cli'] == '' && $_GET['b_m2_hasta_cli'] == '' && $_GET['b_m2p_desde_cli'] == '' &&
//   $_GET['b_m2p_hasta_cli'] == ''
...
if (isset($_GET['debug'])) {
  ...
  $nprop = '';
  if(
!isset($_GET['b_sale_cli'][0]) &&
!isset($_GET['b_type_cli'][0]) &&
!isset($_GET['b_ocultos_cli'][0]) &&
!isset($_GET['b_loc1_cli'][0]) &&
!isset($_GET['b_loc2_cli'][0]) &&
!isset($_GET['b_costa_cli'][0]) &&
!isset($_GET['b_loc3_cli'][0]) &&
!isset($_GET['b_loc4_cli'][0]) &&
!isset($_GET['b_opciones_cli'][0]) &&
!isset($_GET['b_opciones2_cli'][0]) &&
!isset($_GET['b_ref_cli'][0]) &&
...
$_GET['b_m2_desde_cli'] == '' &&
$_GET['b_m2_hasta_cli'] == '' &&
$_GET['b_dist_beach_val_cli=K'] == '' &&
$_GET['b_dist_beach_from_cli'] == '' &&
$_GET['b_dist_beach_to_cli'] == '' &&
$_GET['b_dist_amenit_val_cli=K'] == '' &&
$_GET['b_dist_amenit_from_cli'] == '' &&
$_GET['b_dist_amenit_to_cli'] == '' &&
$_GET['b_beds_cli'] == '' &&
$_GET['b_baths_cli'] == '' &&
$_GET['b_orientacion_cli'] == '' &&
$_GET['b_m2p_desde_cli'] == '' &&
$_GET['b_m2p_hasta_cli'] == '' &&
$_GET['b_dist_airport_val_cli=K'] == '' &&
$_GET['b_dist_airport_from_cli'] == '' &&
$_GET['b_dist_airport_to_cli'] == '' &&
$_GET['b_dist_golf_val_cli=K'] == '' &&
$_GET['b_dist_golf_from_cli'] == '' &&
$_GET['b_dist_golf_to_cli'] == ''
