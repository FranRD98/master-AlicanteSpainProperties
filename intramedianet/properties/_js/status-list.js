                ...
                "render": function ( data, type, row ) {
                    btns = '<div class="dropdown d-inline-block w-100">';
                        ...
                        btns += '<ul class="dropdown-menu dropdown-menu-end">';
                            btns += '<li><a href="status-form.php?id_sta=' + data + '&amp;KT_back=1" class="dropdown-item edit-item-btn"><i class="fa-regular fa-pencil align-bottom me-1"></i> ' + dtEditar + '</a></li>';
                            if (data > 5) {
                                if (canDel == 1) {
                                    btns += '<li><hr class="dropdown-divider"></li>';
                                    btns += '<li><a href="status-form.php?id_sta=' + data + '&amp;KT_back=1&amp;KT_Delete1=1" class="dropdown-item remove-item-btn text-danger delrow"><i class="fa-regular fa-trash-can me-1"></i> ' + dtEliminar + '</a></li>';
                                }
                            }
                        btns += '</ul>';
                    btns += '</div>';
