...
if ($totalRows_rsExisteEmail == 0) {
    ...
    $telefonoCli = limpiarTelefono($row_rsConsulta['telefono_cons']);
    ...
    (NULL, '0', '".mysqli_real_escape_string($inmoconn,$row_rsConsulta['nombre_cons'])."', '', NULL, '".$telefonoCli."', NULL, '".$row_rsConsulta['email_cons']."', NULL, NULL, NULL, CURRENT_TIMESTAMP, NULL, NULL, NULL, '0', NULL, '".$row_rsConsulta['idioma_cons']."', NULL, '0', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    ";
    ...
    $query_rsInsert = "
    UPDATE properties_enquiries SET client_cons  = '".$id."' WHERE id_cons = '".$row_rsConsulta['id_cons']."'
    ";
    $rsInsert = mysqli_query($inmoconn,$query_rsInsert) or die(mysqli_error());
