...
if(isset($_POST['name_fil'])){
  ...
  // Add columns  
  $customTransaction->addColumn("name_fil", "STRING_TYPE", "POST", "name_fil", $_POST['name_fil']);
...
<div class="bg-light">
    <div class="mb-2 <?php if($tNGs->displayFieldError("custom", "name_fil") != '') { ?>error<?php } ?>">
        ...
        <div class="controls">
            <input type="text" name="name_fil" id="name_fil" value="<?php if(isset($row_rsImg['name_fil'])) echo KT_escapeAttribute($row_rsImg['name_fil']); ?>" size="32" maxlength="255" class="form-control">
