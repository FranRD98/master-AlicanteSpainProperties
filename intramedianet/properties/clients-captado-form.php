...
$upd_properties_client_captado = new tNG_update($conn_inmoconn);
$tNGs->addTransaction($upd_properties_client_captado);
// Register triggers
$upd_properties_client_captado->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_properties_client_captado->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_properties_client_captado->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
// Add columns
$upd_properties_client_captado->setTable("properties_client_captado");
$upd_properties_client_captado->addColumn("category_en_cap", "STRING_TYPE", "POST", "category_en_cap");
$upd_properties_client_captado->addColumn("category_es_cap", "STRING_TYPE", "POST", "category_es_cap");
// $upd_properties_client_captado->addColumn("category_fr_cap", "STRING_TYPE", "POST", "category_fr_cap");
$upd_properties_client_captado->setPrimaryKey("id_cap", "NUMERIC_TYPE", "GET", "id_cap");

// Make an instance of the transaction object
$del_properties_client_captado = new tNG_delete($conn_inmoconn);
$tNGs->addTransaction($del_properties_client_captado);
// Register triggers
$del_properties_client_captado->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Delete1");
$del_properties_client_captado->registerTrigger("STARTER", "Trigger_Default_Starter", 2, "GET", "KT_Delete1");
$del_properties_client_captado->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
$del_properties_client_captado->registerTrigger("BEFORE", "Trigger_CheckDetail", 40);
// Add columns
$del_properties_client_captado->setTable("properties_client_captado");
$del_properties_client_captado->setPrimaryKey("id_cap", "NUMERIC_TYPE", "GET", "id_cap");
...
<body>
    ...
    <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" class="needs-validation" novalidate enctype="multipart/form-data">
        ...
        <input type="hidden" name="kt_pk_properties_client_captado" class="id_field" value="<?php if(isset($row_rsproperties_client_captado['kt_pk_properties_client_captado'])) echo KT_escapeAttribute($row_rsproperties_client_captado['kt_pk_properties_client_captado']); ?>" />
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card position-relative">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4 <?php if($tNGs->displayFieldError("properties_client_captado", "category_en_cap") != '') { ?>has-error<?php } ?>">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" name="category_en_cap" id="category_en_cap" value="<?php echo KT_escapeAttribute($row_rsproperties_client_captado['category_en_cap']); ?>" size="32" maxlength="255" class="form-control required" required>
                                      <div class="invalid-feedback">
                                          <?php __('Este campo es obligatorio.'); ?>
                                      </div>
                                    </div>
                                    <?php echo $tNGs->displayFieldError("properties_client_captado", "category_en_cap"); ?>
                                </div>


                                <div class="form-group <?php if($tNGs->displayFieldError("properties_client_captado", "category_es_cap") != '') { ?>has-error<?php } ?>">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" name="category_es_cap" id="category_es_cap" value="<?php echo KT_escapeAttribute($row_rsproperties_client_captado['category_es_cap']); ?>" size="32" maxlength="255" class="form-control required" required>
                                      <div class="invalid-feedback">
                                          <?php __('Este campo es obligatorio.'); ?>
                                      </div>
                                    </div>
                                    <?php echo $tNGs->displayFieldError("properties_client_captado", "category_es_cap"); ?>
                                </div>
