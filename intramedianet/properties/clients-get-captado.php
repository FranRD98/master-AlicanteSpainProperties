...
$query_rsOwner = "SELECT * FROM properties_client_captado ORDER BY category_".$_GET['lang']."_cap ASC";
...
<option value=""><?php echo NXT_getResource("Select one..."); ?></option>
  ...
  do {
  ?>
  <option value="<?php echo $row_rsOwner['id_cap']?>"<?php if (!(strcmp($row_rsOwner['id_cap'], $_GET['s']))) {echo "SELECTED";} ?>><?php echo $row_rsOwner['category_'.$_GET['lang'].'_cap']?></option>
  <?php
