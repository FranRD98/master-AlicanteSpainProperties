...
$ins_properties_client_sources = new tNG_insert($conn_inmoconn);
$tNGs->addTransaction($ins_properties_client_sources);
// Register triggers
$ins_properties_client_sources->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Insert1");
$ins_properties_client_sources->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$ins_properties_client_sources->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
// Add columns
$ins_properties_client_sources->setTable("properties_client_sources");
$ins_properties_client_sources->addColumn("category_en_sts", "STRING_TYPE", "POST", "category_en_sts");
...
// $ins_properties_client_sources->addColumn("category_fr_sts", "STRING_TYPE", "POST", "category_fr_sts");
$ins_properties_client_sources->setPrimaryKey("id_sts", "NUMERIC_TYPE");

// Make an update transaction instance
$upd_properties_client_sources = new tNG_update($conn_inmoconn);
$tNGs->addTransaction($upd_properties_client_sources);
// Register triggers
$upd_properties_client_sources->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_properties_client_sources->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_properties_client_sources->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
// Add columns
$upd_properties_client_sources->setTable("properties_client_sources");
$upd_properties_client_sources->addColumn("category_en_sts", "STRING_TYPE", "POST", "category_en_sts");
...
// $upd_properties_client_sources->addColumn("category_fr_sts", "STRING_TYPE", "POST", "category_fr_sts");
$upd_properties_client_sources->setPrimaryKey("id_sts", "NUMERIC_TYPE", "GET", "id_sts");

// Make an instance of the transaction object
$del_properties_client_sources = new tNG_delete($conn_inmoconn);
$tNGs->addTransaction($del_properties_client_sources);
// Register triggers
$del_properties_client_sources->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Delete1");
$del_properties_client_sources->registerTrigger("STARTER", "Trigger_Default_Starter", 2, "GET", "KT_Delete1");
$del_properties_client_sources->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
$del_properties_client_sources->registerTrigger("BEFORE", "Trigger_CheckDetail", 40);
// Add columns
$del_properties_client_sources->setTable("properties_client_sources");
$del_properties_client_sources->setPrimaryKey("id_sts", "NUMERIC_TYPE", "GET", "id_sts");

// Execute all the registered transactions
$tNGs->executeTransactions();

// Get the transaction recordset
$rsproperties_client_sources = $tNGs->getRecordset("properties_client_sources");
$row_rsproperties_client_sources = mysqli_fetch_assoc($rsproperties_client_sources);
$totalRows_rsproperties_client_sources = mysqli_num_rows($rsproperties_client_sources);
?>
<!doctype html>
...
<body>
    ...
    <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" class="needs-validation" novalidate enctype="multipart/form-data">
        ...
        <input type="hidden" name="kt_pk_properties_client_sources" class="id_field" value="<?php if(isset($row_rsproperties_client_sources['kt_pk_properties_client_sources'])) echo KT_escapeAttribute($row_rsproperties_client_sources['kt_pk_properties_client_sources']); ?>" />
                        ...
                        <div class="card position-relative">
                            <div class="card-header align-items-center d-flex">
                                <div class="flex-grow-1 oveflow-hidden">
                                    <h4 class="card-title mb-0 flex-grow-1"><?php __('Origen'); ?></h4>
                                </div>
                            </div>
                            <div class="card-body">

                                <div class="mb-4 <?php if($tNGs->displayFieldError("properties_client_sources", "category_en_sts") != '') { ?>has-error<?php } ?>">
                                    <label for="category_en_sts" class="form-label required"><?php __('Origen'); ?>:</label>
                                    <div class="input-group">
                                      <span class="input-group-text"><img src="/intramedianet/includes/assets/imgs/flags/en.svg" alt="" style="height: 20px;"></span>
                                      <input type="text" name="category_en_sts" id="category_en_sts" value="<?php echo KT_escapeAttribute($row_rsproperties_client_sources['category_en_sts']); ?>" size="32" maxlength="255" class="form-control required" required>
                                      <div class="invalid-feedback">
                                          <?php __('Este campo es obligatorio.'); ?>
                                      </div>
                                    </div>
                                    <?php echo $tNGs->displayFieldError("properties_client_sources", "category_en_sts"); ?>
                                </div>
