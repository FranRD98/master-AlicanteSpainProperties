...
?><?php
  ...
  /* DB table to use */
  $sTable = "properties_consultas_log";
...
$mail = '';
  ...
  $sQuery = "
    SELECT SQL_CALC_FOUND_ROWS
      properties_consultas_log.id_con,
      text_con,
      properties_consultas_log.name_con,
      properties_consultas_log.email_con,
      properties_consultas_log.phone_con,
      properties_consultas_log.lang_con,
      properties_consultas_log.date_con,
      properties_consultas_log.lang_con as lang_sort,
      (SELECT id_cli FROM properties_client WHERE email_cli = email_con limit 1) AS clientExists,
      (SELECT id_pro FROM properties_owner WHERE email_pro = email_con limit 1) AS ownerExists
    FROM properties_consultas_log
