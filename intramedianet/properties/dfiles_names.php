...
$query_rsImg = sprintf("SELECT * FROM properties_datos_files WHERE id_fil = %s", GetSQLValueString($colname_rsImg, "int"));
...
$customTransaction->setSQL("UPDATE  `properties_datos_files` SET  name_fil = '". $_POST['name_fil']."'  WHERE  `properties_datos_files`.`id_fil` = ".$_POST['p']." LIMIT 1 ;");
// Add columns
