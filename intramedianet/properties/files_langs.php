...
if(isset($_GET['lang_fil']))
  $customTransaction->setSQL("UPDATE  `properties_files` SET  lang_fil = '".$_GET['lang_fil']."'  WHERE  `properties_files`.`id_fil` = ".$_GET['p']." LIMIT 1 ;");
...
<div class="form-group <?php if($tNGs->displayFieldError("custom", "lang_fil") != '') { ?>has-error<?php } ?>">
    <label for="lang_fil" class="form-label"><?php __('Idioma'); ?>:</label>
