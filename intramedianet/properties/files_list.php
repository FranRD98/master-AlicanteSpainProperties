...
if (isset($_GET['id_prop'])) {
  $colname_rsFiles = $_GET['id_prop'];
}

$colname_rsFiles = mysqli_real_escape_string($inmoconn, $colname_rsFiles);

$query_rsFiles = sprintf("SELECT * FROM properties_files WHERE property_fil = %s ORDER BY order_fil", GetSQLValueString($colname_rsFiles, "int"));
