...
$targetDir = '../../media/files/properties/';
...
$query_rsMax ="SELECT MAX(order_fil) + 1  as max FROM properties_files WHERE property_fil = '".$_GET['id_prop']."'";
...
$row_rsMax = mysqli_fetch_assoc($rsMax);
  ...
  $query_rsUserTrad = "INSERT INTO  `properties_files` SET
`property_fil`  = '".$_GET['id_prop']."',
`file_fil` = '".$fileName."',
`order_fil`= ".$row_rsMax['max']."
";
