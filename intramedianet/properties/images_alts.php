...
$query_rsImg = sprintf("SELECT * FROM properties_images WHERE id_img = %s", GetSQLValueString($colname_rsImg, "int"));
...
$customTransaction->setSQL("UPDATE  `properties_images` SET  ". $set."  WHERE  `properties_images`.`id_img` = ".$_GET['p']." LIMIT 1 ;");
// Add columns
foreach($languages as $value) {
