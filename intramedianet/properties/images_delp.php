...
$query_rsImagen = "SELECT * FROM properties_images_priv WHERE `properties_images_priv`.`id_img` = '".$_GET['id']."'";
...
$query_rsImagenes = "DELETE FROM `properties_images_priv` WHERE `properties_images_priv`.`id_img` = '".$_GET['id']."' LIMIT 1;";
...
$ord = 1;
	...
	if(unlink('../../media/images/propertiesprv/'.$img)) {
        tNG_deleteThumbnails('../../media/images/propertiesprv/thumbnails/', $imgid, '');
