...
$targetDir = '../../media/images/properties/';
//$targetDir = '/home/lawres/public_html/media/documentos/consultas/';
...
if(
	!isset($_SESSION['unique_name']) || 
	( isset($_SESSION['unique_name']) && $fileName!=$_SESSION['unique_name'])
){
...
$rsImagenes = mysqli_query($inmoconn,$query_rsImagenes)
or die(mysqli_error());


$query_rsMaxPDF ="SELECT MAX(order_pdf_img) + 1  as max FROM properties_images WHERE property_img = '".$_GET['id_prop']."'";
$rsMaxPDF = mysqli_query($inmoconn,$query_rsMaxPDF) or die(mysqli_error());
$row_rsMaxPDF = mysqli_fetch_assoc($rsMaxPDF);
...
$rsUserTrad = mysqli_query($inmoconn,$query_rsUserTrad) or die(mysqli_error());
  ...
  generateThumbnails($_SERVER["DOCUMENT_ROOT"] . '/media/images/properties/' . $fileName, mysqli_insert_id($inmoconn));  // /intramedianet/includes/resources/translate.php
