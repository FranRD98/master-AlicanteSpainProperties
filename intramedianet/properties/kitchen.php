...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-user-chef"></i> <?php echo __('Cocinas'); ?></h4>
                    <div class="flex-shrink-0">
                        <a href="kitchen-form.php?KT_back=1" class="btn btn-success btn-sm"><i class="fa-regular fa-plus me-1"></i> <?php __('Añadir'); ?></a>
                    </div>
                </div>
                <div class="card-body">
    ...
    <script src="_js/kitchen-list.js" type="text/javascript"></script>
