...
?><?php
  ...
  $aColumns = array();
  array_push($aColumns, 'name_' . $lang_adm . '_loc1');

  array_push($aColumns, 'id_loc1');

  /* Indexed column (used for fast and accurate table cardinality) */
  $sIndexColumn = "id_loc1";

  /* DB table to use */
  $sTable = "properties_loc1";
   ...
   * Get data to display
   */
  $campos = 'name_' . $lang_adm . '_loc1, ';

  $sQuery = "
    SELECT SQL_CALC_FOUND_ROWS
      " . $campos . "
      id_loc1
    FROM properties_loc1
    $sWhere
    $sOrder
    $sLimit
  ";
