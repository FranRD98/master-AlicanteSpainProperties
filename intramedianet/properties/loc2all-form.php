...
$query_rsMenu = "SELECT id_loc2, name_".$lang_adm."_loc2 as town, loc1_loc2 FROM properties_loc2 WHERE parent_loc2 IS NULL AND id_loc2 != '".$_GET['id_loc2']."' ORDER BY name_".$lang_adm."_loc2 ASC";
...
$ins_properties_loc2->addColumn("loc1_loc2", "NUMERIC_TYPE", "GET", "NxT_id_loc2");
if($mapeo == 1) {
            ...
            <div class="col-lg-12">
                <div class="card position-relative">
                    <div class="card-header align-items-center d-flex card-header-fix">
                        <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-earth-europe"></i> <?php echo __('Mapear provincias'); ?></h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <?php foreach($languages as $value) { ?>
                                        ...
                                        <div class="mb-4">
                                            <label for="name_<?php echo $value; ?>_loc2" class="form-label required"><?php __('Zona'); ?>:</label>
                                ...
                                <div class="<?php if($tNGs->displayFieldError("properties_loc2", "parent_loc2") != '') { ?>has-error<?php } ?>">
                                    ...
                                    <select name="parent_loc2" id="parent_loc2" class="select2">
                                      <option value="" <?php if (isset($row_rsproperties_loc2['parent_loc2']) && !(strcmp('', $row_rsproperties_loc2['parent_loc2']))) {echo "SELECTED";} ?>><?php echo NXT_getResource("Select one..."); ?></option>
                                      <?php do {  ?>
                                      <option value="<?php echo $row_rsMenu['id_loc2']?>"<?php if (isset($row_rsproperties_loc2['parent_loc2']) && !(strcmp($row_rsMenu['id_loc2'], $row_rsproperties_loc2['parent_loc2']))) {echo "SELECTED";} ?>><?php echo $row_rsMenu['town']?> (<?php echo $row_rsMenu['id_loc2']?>)</option>
                                      <?php
