...
// $rsparent1 = mysqli_query($query_rsparent1, $inmoconn) or die(mysqli_error());
...
// $rsparent2 = mysqli_query($query_rsparent2, $inmoconn) or die(mysqli_error());
...
<body>
    ...
    <script src="_js/loc2all-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
