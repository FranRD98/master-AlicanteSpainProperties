...
<body>
            ...
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    ...
                    <div class="flex-shrink-0">
                        ...
                        <a href="loc3-form.php?NxT_id_loc1=<?php echo $_GET['NxT_id_loc1'] ?>&NxT_id_loc2=<?php echo $_GET['NxT_id_loc2'] ?>&KT_back=1" class="btn btn-success btn-sm"><i class="fa-regular fa-plus me-1"></i> <?php __('Añadir'); ?></a>
                        <?php endif ?>
                        ...
                        <table class="display table table-bordered align-middle" id="records-tables" width="100%">
                            <thead class="table-light">
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <?php if($actCostas == 1) { ?>
                                    <td style="width: 200px;"><input type="text" name="costa" id="<?php echo 'costa'; ?>" class="form-control form-control-sm"></td>
                                    <?php } ?>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="<?php echo $totrows ?>" class="dataTables_empty"><?php __('Cargando datos del servidor'); ?></td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <script>
    var numCols = <?php echo $totrows - 1 ?>;
    var NxT_id_loc1 = <?php echo $_GET['NxT_id_loc1']; ?>;
    var NxT_id_loc2 = <?php echo $_GET['NxT_id_loc2']; ?>;
    </script>

    <script src="_js/loc3-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
