...
<body>
  ...
  <?php include( $_SERVER["DOCUMENT_ROOT"] . '/intramedianet/includes/inc.header.php' ); ?>
                        ...
                        <table class="display table table-bordered align-middle" id="records-tables" width="100%">
                            <thead class="table-light">
                                ...
                                <tr>
                                    ...
                                    <?php if ($actCostas == 1): ?>
                                    <td><input type="text" name="<?php echo 'coast'; ?>" id="<?php echo 'coast'; ?>" class="form-control input-sm"></td>
                                    <?php endif ?>
    ...
    <script src="_js/loc3all-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
