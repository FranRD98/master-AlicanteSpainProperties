...
$query_rsparent3 = "SELECT id_loc3, name_".$lang_adm."_loc3 as town FROM properties_loc3 WHERE id_loc3 = ".$_GET['NxT_id_loc3']." ORDER BY name_".$lang_adm."_loc3 ASC";
$rsparent3 = mysqli_query($inmoconn,$query_rsparent3) or die(mysqli_error() . '<hr>' . $query_rsparent3);
$row_rsparent3 = mysqli_fetch_assoc($rsparent3);
$totalRows_rsparent3 = mysqli_num_rows($rsparent3);


$query_rsMenu = "SELECT id_loc4, name_".$lang_adm."_loc4 as town, loc3_loc4 FROM properties_loc4 WHERE parent_loc4 IS NULL AND id_loc4 != '".$_GET['id_loc4']."' ORDER BY name_".$lang_adm."_loc4 ASC";
...
$ins_properties_loc4->addColumn("loc3_loc4", "NUMERIC_TYPE", "GET", "NxT_id_loc2");
                            ...
                            <div class="card-body">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb p-3 py-2 bg-light">
                                        ...
                                        <li class="breadcrumb-item"><a href="/intramedianet/properties/loc3.php?NxT_id_loc1=<?php echo $_GET['NxT_id_loc1'] ?>&NxT_id_loc2=<?php echo $_GET['NxT_id_loc2'] ?>"><?php echo $row_rsparent3['town'] ?></a></li>
                                ...
                                <div class="<?php if($tNGs->displayFieldError("properties_loc4", "parent_loc4") != '') { ?>has-error<?php } ?>">
                                    ...
                                    <select name="parent_loc4" id="parent_loc4" class="select2">
                                      <option value="" <?php if (isset($row_rsproperties_loc4['parent_loc4']) && !(strcmp('', $row_rsproperties_loc4['parent_loc4']))) {echo "SELECTED";} ?>><?php echo NXT_getResource("Select one..."); ?></option>
                                      <?php do {  ?>
                                      <option value="<?php echo $row_rsMenu['id_loc4']?>"<?php if (isset($row_rsproperties_loc4['parent_loc4']) && !(strcmp($row_rsMenu['id_loc4'], $row_rsproperties_loc4['parent_loc4']))) {echo "SELECTED";} ?>><?php echo $row_rsMenu['town']?> (<?php echo $row_rsMenu['id_loc4']?>)</option>
                                      <?php
