...
$query_rsImg = sprintf("SELECT * FROM properties_owner_files WHERE id_fil = %s", GetSQLValueString($colname_rsImg, "int"));
...
if($set!='')
  $customTransaction->setSQL("UPDATE  `properties_owner_files` SET  name_fil = '". $_POST['name_fil']."'  WHERE  `properties_owner_files`.`id_fil` = ".$_POST['p']." LIMIT 1 ;");
// Add columns
