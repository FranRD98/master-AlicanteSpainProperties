...
$upd_properties_owner_states = new tNG_update($conn_inmoconn);
$tNGs->addTransaction($upd_properties_owner_states);
// Register triggers
$upd_properties_owner_states->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_properties_owner_states->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_properties_owner_states->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
// Add columns
$upd_properties_owner_states->setTable("properties_owner_states");
$upd_properties_owner_states->addColumn("category_en_sts", "STRING_TYPE", "POST", "category_en_sts");
$upd_properties_owner_states->addColumn("category_es_sts", "STRING_TYPE", "POST", "category_es_sts");
// $upd_properties_owner_states->addColumn("category_fr_sts", "STRING_TYPE", "POST", "category_fr_sts");
$upd_properties_owner_states->setPrimaryKey("id_sts", "NUMERIC_TYPE", "GET", "id_sts");

// Make an instance of the transaction object
$del_properties_owner_states = new tNG_delete($conn_inmoconn);
$tNGs->addTransaction($del_properties_owner_states);
// Register triggers
$del_properties_owner_states->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Delete1");
$del_properties_owner_states->registerTrigger("STARTER", "Trigger_Default_Starter", 2, "GET", "KT_Delete1");
$del_properties_owner_states->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../includes/nxt/back.php");
$del_properties_owner_states->registerTrigger("BEFORE", "Trigger_CheckDetail", 40);
// Add columns
$del_properties_owner_states->setTable("properties_owner_states");
$del_properties_owner_states->setPrimaryKey("id_sts", "NUMERIC_TYPE", "GET", "id_sts");
...
<body>
    ...
    <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" class="needs-validation" novalidate enctype="multipart/form-data">
        ...
        <input type="hidden" name="kt_pk_properties_owner_states" class="id_field" value="<?php if(isset($row_rsproperties_owner_states['kt_pk_properties_owner_states'])) echo KT_escapeAttribute($row_rsproperties_owner_states['kt_pk_properties_owner_states']); ?>" />
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card position-relative">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4 <?php if($tNGs->displayFieldError("properties_owner_states", "category_en_sts") != '') { ?>has-error<?php } ?>">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" name="category_en_sts" id="category_en_sts" value="<?php echo KT_escapeAttribute($row_rsproperties_owner_states['category_en_sts']); ?>" size="32" maxlength="255" class="form-control required" required>
                                      <div class="invalid-feedback">
                                          <?php __('Este campo es obligatorio.'); ?>
                                      </div>
                                    </div>
                                    <?php echo $tNGs->displayFieldError("properties_owner_states", "category_en_sts"); ?>
                                </div>


                                <div class="form-group <?php if($tNGs->displayFieldError("properties_owner_states", "category_es_sts") != '') { ?>has-error<?php } ?>">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" name="category_es_sts" id="category_es_sts" value="<?php echo KT_escapeAttribute($row_rsproperties_owner_states['category_es_sts']); ?>" size="32" maxlength="255" class="form-control required" required>
                                      <div class="invalid-feedback">
                                          <?php __('Este campo es obligatorio.'); ?>
                                      </div>
                                    </div>
                                    <?php echo $tNGs->displayFieldError("properties_owner_states", "category_es_sts"); ?>
                                </div>
