...
$targetDir = '../../media/images/propertiesplanos/';
...
or die(mysqli_error());
  ...
  $query_rsUserTrad = "INSERT INTO  `properties_planos` SET
...
";
  ...
  generateThumbnails($_SERVER["DOCUMENT_ROOT"] . '/media/images/propertiesplanos/' . $fileName, $id, 'propertiesplanos');  // /intramedianet/includes/resources/translate.php
