...
?><?php
  ...
  $aColumns = array();
  array_push($aColumns, 'pool_' . $lang_adm . '_pl');

  array_push($aColumns, 'id_pl');

  /* Indexed column (used for fast and accurate table cardinality) */
  $sIndexColumn = "id_pl";

  /* DB table to use */
  $sTable = "properties_pool";
  ...
  // echo "</pre><hr>";
    ...
    for ( $i=0 ; $i<count($aColumns) ; $i++ )
    {
      ...
      {
          if ( $aColumns[$i] == "color_pl" || $aColumns[$i] == "text_color_pl" )
          {
            /* Special output formatting for 'version' column */
