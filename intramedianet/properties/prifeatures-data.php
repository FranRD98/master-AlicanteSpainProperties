...
?><?php
  ...
  $aColumns = array();
  array_push($aColumns, 'feature_' . $lang_adm . '_feat');
  ...
  /* DB table to use */
  $sTable = "properties_features_priv";
   ...
   * Get data to display
   */
  $campos = '`feature_' . $lang_adm . '_feat`, ';

  $sQuery = "
    SELECT SQL_CALC_FOUND_ROWS
      " . $campos . "
      id_feat
    FROM properties_features_priv
    $sWhere
    $sOrder
    $sLimit
  ";
