...
?><?php
  ...
  $aColumns = array('id_prop', 'image_img', 'referencia_prop', 'status_' .$lang_adm. '_sta', 'types_' .$lang_adm. '_typ', 'name_' .$lang_adm. '_loc3', 'name_' .$lang_adm. '_loc4', 'preci_reducidoo_prop', 'activado_prop', 'nombre_pro', 'telefono_fijo_pro', 'habitaciones_prop', 'aseos_prop', 'piscina_prop', 'parking_prop', 'id_prop', 'id_prop2', 'rate');
              ...
              if ($aColumns[$i] == 'id_prop2') {
                if (in_array($aRow['id_prop'], $idemails)) {
                  ...
                  if ($aColumns[$i] == 'referencia_prop') {
                      $row[] = '<div class="text-center"><b>' . $aRow[ $aColumns[$i] ] . '</b><a href="_update-client-props.php?act=add&sec=no&id_prop=' . $aRow['id_prop'] . '&id_cli=' . $_GET['id_cli'] . '" class="btn btn-danger btn-sm w-100 btn-clnt" target="_blank"><i class="fa-regular fa-xmark"></i> ' . __('Excluir', true) . '</a><a href="properties-form.php?id_prop=' . $aRow['id_prop'] . '&KT_back=1" class="btn btn-success btn-sm w-100 mt-2" target="_blank"><i class="fa-regular fa-pencil"></i> ' . __('Editar', true) . '</a></div>';
                  } else {
                      if ($aColumns[$i] == 'rate') {
