...
?><?php
  ...
  $aColumns = array();
  array_push($aColumns, 'tag_' . $lang_adm . '_tag');
  array_push($aColumns, 'color_tag');
  array_push($aColumns, 'text_color_tag');




  array_push($aColumns, 'id_tag');

  /* Indexed column (used for fast and accurate table cardinality) */
  $sIndexColumn = "id_tag";

  /* DB table to use */
  $sTable = "properties_tags";
  ...
  // echo "</pre><hr>";
    ...
    for ( $i=0 ; $i<count($aColumns) ; $i++ )
    {
      ...
      {
          if ( $aColumns[$i] == "color_tag" || $aColumns[$i] == "text_color_tag" )
          {
            /* Special output formatting for 'version' column */
