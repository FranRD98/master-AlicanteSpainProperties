...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-tags"></i> <?php echo __('Etiquetas'); ?></h4>
                    <div class="flex-shrink-0">
                        <a href="tags-form.php?KT_back=1" class="btn btn-success btn-sm"><i class="fa-regular fa-plus me-1"></i> <?php __('Añadir'); ?></a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="display table table-bordered align-middle" id="records-tables" width="100%">
                            <thead class="table-light">
                                <tr>
                                    <th><?php __('Etiqueta'); ?></th>
                                    <th style="width: 80px;"><?php __('Fondo'); ?></th>
                                    <th style="width:30px;"><?php __('Texto'); ?></th>
                                    <th id="actions"></th>
                                </tr>
                                <tr>
    ...
    <script src="_js/tags-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
