...
$query_rsMax ="SELECT MAX(order_vid) + 1  as max FROM properties_videos WHERE property_vid = '".$_GET['p']."'";
...
$query_rsVideos = "INSERT INTO `properties_videos` SET `properties_videos`.`property_vid` = '".$_GET['p']."'  , `properties_videos`.`video_vid` = '".mysqli_real_escape_string($inmoconn,$_GET['vid'])."',  `properties_videos`.`order_vid` = '".$row_rsMax['max']."';";
...
?>
				<li class="pull-left" id="order_<?php echo $id; ?>" data-id="<?php echo $id; ?>">
				    ...
				    <div class="img-thumbnail pull-left" style="width: 250px;">
				      ...
				      <?php echo $youtube; ?>
				      <p class="text-center"><a href="/intramedianet/properties/videos_del.php" data-id="<?php echo $id  ?>" class="btn btn-danger btn-sm del-vid"><i class="fa-regular fa-trash-can"></i></a></p>
				    </div>
