...
<body>
                ...
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0 ms-2 d-none d-md-flex">
                        <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" href="whatsapp.php" role="tab" aria-selected="false" tabindex="-1">
    ...
    <script src="_js/report-whatsapp-search.js?id=<?php echo time(); ?>" type="text/javascript"></script>
