...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-link"></i> <?php echo __('Quicklinks'); ?></h4>
                        ...
                        <table class="display table table-bordered align-middle" id="records-tables" width="100%">
                            <thead class="table-light">
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="destacado_nws" id="destacado_nws">

                                        <select name="destacado_nws_sel" id="destacado_nws_sel" class="form-select form-select-sm">
                                            <option value=""><?php __('Todos'); ?></option>
                                            <option value="<?php __('Sí'); ?>"><?php __('Sí'); ?></option>
                                            <option value="<?php __('No'); ?>"><?php __('No'); ?></option>
                                       </select>
                                    ...
                                    <td><input type="text" name="date_nws" id="date_nws" class="form-control form-control-sm"></td>
    ...
    <script>
    var numCols = 4;
    var lang = '<?php echo $lang_adm; ?>';
    </script>

    <script src="/intramedianet/quicklinks/_js/landings-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
