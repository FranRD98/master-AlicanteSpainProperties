...
// ini_set("display_errors", 1);
  ...
  array_push($aColumns, 'categorias_' . $lang_adm . '_cat');

  array_push($aColumns, 'id_cat');

  /* Indexed column (used for fast and accurate table cardinality) */
  $sIndexColumn = "id_cat";

  /* DB table to use */
  $sTable = "tasks_categories";
  ...
  while ( $aRow = mysqli_fetch_array( $rResult ) )
  {
    ...
    for ( $i=0 ; $i<count($aColumns) ; $i++ )
    {
      if ( $aColumns[$i] == "categorias_en_catxx" )
      {
