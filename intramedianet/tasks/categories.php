...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-list"></i> <?php echo __('Estados'); ?></h4>
    ...
    <script src="/intramedianet/tasks/_js/categories-list.js" type="text/javascript"></script>
