...
$query_rsImg = sprintf("SELECT * FROM teams_fotos WHERE id_img = %s", GetSQLValueString($colname_rsImg, "int"));
...
$customTransaction->setSQL("UPDATE  `teams_fotos` SET  ". $set."  WHERE  `teams_fotos`.`id_img` = ".$_GET['p']." LIMIT 1 ;");
// Add columns
foreach($languages as $value) {
