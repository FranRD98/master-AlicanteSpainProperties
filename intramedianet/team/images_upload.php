...
$query_rsMax ="SELECT MAX(orden_img) + 1  as max FROM teams_fotos WHERE noticia_img = '".$_GET['id_nws']."'";
...
$row_rsMax = mysqli_fetch_assoc($rsMax);
  ...
  $query_rsUserTrad = "INSERT INTO  `teams_fotos` SET
