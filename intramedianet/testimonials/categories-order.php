...
$query_rsCategories = "SELECT category_".$lang_adm."_ct as feat, id_ct as id, orden_ct FROM `news_categories` WHERE type_ct = 10 AND parent_ct = 0 ORDER BY orden_ct ASC";
...
function getChilds($parent) {
    ...
    $query_rsChilds = "SELECT category_".$lang_adm."_ct as feat, id_ct as id, orden_ct FROM `news_categories` WHERE type_ct = 10 AND parent_ct = '" . $parent . "' ORDER BY orden_ct ASC";
...
<body>
    ...
    <div id="second-nav">
        ...
        <div class="btn-toolbar pull-right" role="toolbar">
            ...
            <a href="/intramedianet/news/news.php" class="btn btn-default btn-sm"><?php __('Volver'); ?></a>
        </div>
    </div>
