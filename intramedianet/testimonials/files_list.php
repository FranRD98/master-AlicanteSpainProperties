...
$theValue = mysqli_real_escape_string($inmoconn, $colname_rsFiles);
...
?>
 <?php if($totalRows_rsFiles >=  1) { ?>
                      ...
                      <li class="pull-left" id="order_<?php echo $row_rsFiles['id_fil'] ?>">
                      ...
                      <div class="img-thumbnail pull-left">
                        ...
                        <p class="text-center">
                          ...
                          <img src="/intramedianet/includes/assets/img/flags-langs/<?php echo $row_rsFiles['lang_fil']; ?>.png" alt="" class="pull-right"/>
                          <?php } ?>
                          <a href="#" class="btn btn-success btn-sm edit-name" data-id="<?php echo $row_rsFiles['id_fil'] ?>"><i class="fa fa-pencil"></i></a>
                          <a href="#" class="btn btn-info btn-sm edit-lang" data-id="<?php echo $row_rsFiles['id_fil'] ?>"><i class="fa fa-globe"></i></a>
                          <a href="/intramedianet/news/files_del.php" data-id="<?php echo $row_rsFiles['id_fil'] ?>" class="btn btn-danger btn-sm del-fil"><i class="fa fa-trash-o"></i></a>
                        </p>
                      </div>
