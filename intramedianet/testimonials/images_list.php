...
?>
 <?php if($totalRows_rsImagenes >=  1) { ?>
                      ...
                      <div class="img-thumbnail pull-left">
                        <?php echo showThumbnail($row_rsImagenes['imagen_img'], '/media/images/news/', 140, 100); ?>
                        <p class="text-center"><a href="#" class="btn btn-success btn-sm edit-alt" data-id="<?php echo $row_rsImagenes['id_img'] ?>"><i class="fa-regular fa-pencil"></i></a> <a href="/intramedianet/news/images_del.php" data-id="<?php echo $row_rsImagenes['id_img'] ?>" class="btn btn-danger btn-sm del-img"><i class="fa-regular fa-trash-can"></i></a>
