...
WHERE subcategories.type_ct = 10
...
function addFields(&$tNG) {
  $tNG->addColumn("type_nws", "NUMERIC_TYPE", "EXPRESSION", "10");
  return $tNG->getError();
}
            ...
            <div class="col-lg-12">
                <div class="card position-relative">
                    <div class="card-header align-items-center d-flex card-header-fix">
                        <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-comment-dot"></i> <?php if (@$_GET['id_nws'] == "") { ?><?php echo NXT_getResource("Insert_FH"); ?><?php } else { ?><?php echo NXT_getResource("Update_FH"); ?><?php } ?> <?php echo __('Testimonial'); ?></h4>
                                ...
                                <div class="card position-relative">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="img-thumbnail pull-left">
                                          <?php echo showThumbnail($row_rsImages['imagen_img'], '/media/images/news/', 140, 100); ?>
                                          <p class="text-center"><a href="#" class="btn btn-success btn-sm edit-alt" data-id="<?php echo $row_rsImages['id_img'] ?>"><i class="fa-regular fa-pencil"></i></a> <a href="/intramedianet/team/images_del.php" data-id="<?php echo $row_rsImages['id_img'] ?>" class="btn btn-danger btn-sm del-img"><i class="fa-regular fa-trash-can"></i></a>
