...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-comment-dots"></i> <?php echo __('Testimonials'); ?></h4>
    ...
    <script src="/intramedianet/testimonials/_js/news-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
