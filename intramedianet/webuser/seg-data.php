...
?><?php
   ...
   */
  $aColumns = array( 'nombre_usr', 'ip_log', 'datein_log', 'dateout_log' , 'idusr_log', 'id_log' );
   ...
   */
  $sQuery = "
    SELECT SQL_CALC_FOUND_ROWS `nombre_usr`, `ip_log`, `datein_log`, `dateout_log`, `idusr_log` , `id_log`
    FROM   $sTable  INNER JOIN users ON users_log.idusr_log = users.id_usr
    $sWhere
    $sOrder
    $sLimit
  ";
