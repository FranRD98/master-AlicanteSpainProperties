        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa fa-rectangle-history-circle-user"></i> <a href="users.php"><?php if ($lang_adm == 'es'): ?><?php __('Usuarios'); ?> Website<?php else: ?>Website <?php __('Usuarios'); ?><?php endif ?></a> <i class="fa-regular fa-angle-right"></i> <?php __('Seguimiento'); ?></h4>
