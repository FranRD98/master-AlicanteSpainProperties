...
$colname_rsTotalVisitas = mysqli_real_escape_string($inmoconn, $colname_rsTotalVisitas);
...
$colname_rsHoy = mysqli_real_escape_string($inmoconn, $colname_rsHoy);
...
$colname_rsUser = mysqli_real_escape_string($inmoconn, $colname_rsUser);
...
$colname_rsVisita = mysqli_real_escape_string($inmoconn, $colname_rsVisita);
...
$colname_rsOnline = mysqli_real_escape_string($inmoconn, $colname_rsOnline);
                        ...
                        <div class="mt-3 mt-md-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    ...
                                    <?php else: ?>
                                        <img src="/intramedianet/includes/assets/imgs/user-dummy-img.jpg" id="product-img" style="width: 38px; height: 38px;" class="avatar-sm rounded-circle bg-light">
                                    <?php endif ?>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 fz-6"><span class="counter-value" data-target="<?php echo $row_rsUser['nombre_usr']; ?> <?php echo $row_rsUser['apellidos_usr']; ?>"><?php echo $row_rsUser['nombre_usr']; ?> <?php echo $row_rsUser['apellidos_usr']; ?></span></h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    ...
                    <div class="col col-lg">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 fz-6"><span class="counter-value" data-target="<?php echo gmdate('H:i:s',$media); ?>"><?php echo gmdate('H:i:s',$media); ?></span></h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
