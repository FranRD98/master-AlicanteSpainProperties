...
<body>
        ...
        <div class="col-lg-12">
            <div class="card position-relative">
                <div class="card-header align-items-center d-flex card-header-fix">
                    <h4 class="card-title mb-0 flex-grow-1"><i class="fa-regular fa-users"></i> <?php if ($lang_adm == 'es'): ?><?php __('Usuarios'); ?> Website<?php else: ?>Website <?php __('Usuarios'); ?><?php endif ?></h4>
    ...
    <script src="/intramedianet/webuser/_js/user-list.js?id=<?php echo time(); ?>" type="text/javascript"></script>
