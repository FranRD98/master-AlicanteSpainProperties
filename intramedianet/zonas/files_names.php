...
?>
         ...
         <?php foreach($languages as $value) {  ?>
              <div class="form-group <?php if($tNGs->displayFieldError("custom", "name_".$value."_fil") != '') { ?>error<?php } ?>">
                <label for="name_<?php echo $value; ?>_fil"><?php __('Nombre'); ?>:</label>
                  <div class="input-group">
                    <span class="input-group-addon"><img src="/intramedianet/includes/assets/img/flags-langs/<?php echo $value; ?>.png" alt=""></span>
                    <input type="text" name="name_<?php echo $value; ?>_fil" id="name_<?php echo $value; ?>_fil" value="<?php echo KT_escapeAttribute($row_rscustom['name_'.$value.'_fil']); ?>" size="32" maxlength="255" class="form-control">
