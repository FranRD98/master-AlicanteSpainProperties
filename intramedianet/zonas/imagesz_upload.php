...
$query_rsMax ="SELECT MAX(order_img) + 1  as max FROM zonas_images WHERE zona_img = '".$_GET['id_nws']."'";
...
$query_rsUserTrad = "INSERT INTO  `zonas_images` SET
`zona_img`  = '".$_GET['id_ct']."',
`image_img` = '".$fileName."',
