...
$query_rsMax ="SELECT MAX(order_vid) + 1  as max FROM news_categories_videos WHERE news_vid = '".$_GET['p']."'";
...
$query_rsVideos = "INSERT INTO `news_categories_videos` SET `news_categories_videos`.`news_vid` = '".$_GET['p']."'  , `news_categories_videos`.`video_vid` = '".mysqli_real_escape_string($inmoconn, $_GET['vid'])."',  `news_categories_videos`.`order_vid` = '".$row_rsMax['max']."';";
...
<li class="pull-left" id="order_<?php echo $id; ?>" data-id="<?php echo $id; ?>">
    ...
    <div class="img-thumbnail pull-left" style="width: 250px;">
      ...
      <?php echo $youtube; ?>
      <p class="text-center"><a href="/intramedianet/zonas/videos_del2.php" data-id="<?php echo $id  ?>" class="btn btn-danger btn-sm del-vid"><i class="fa-regular fa-trash-can"></i></a></p>
    </div>
