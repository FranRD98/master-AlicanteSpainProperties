var fakewaffle = ( function ($, fakewaffle) {
    ...
    fakewaffle.responsiveTabs = function (collapseDisplayed) {
        ...
        $.each(collapseDisplayed, function () {
            hidden += ' hidden-' + this + '-up';
            visible += ' hidden-' + upSizes[this] + '-down';
        });
        ...
        $.each(tabGroups, function (index) {
            ...
            collapseDiv = $('<div></div>', {
                'class': 'accordion responsive mt-4' + visible,
            ...
            $.each(tabs, function () {
                ...
                collapseDiv.append(
                    $('<div>').attr('class', newParentClass).html(
                        $('<div>').attr('class', 'card-header p-0').html(
                            $('<h6>').attr('class', 'mb-0').html(
                                $('<a>', {
                                    'class': newLinkClass,
    ...
    fakewaffle.bindTabToCollapse = function () {
        ...
        var collapse = $('.accordion.responsive').find('.collapse');
