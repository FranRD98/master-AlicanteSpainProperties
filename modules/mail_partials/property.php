                      ...
                      <td style="vertical-align: top; width: 100%; text-align: left; overflow-x: hidden">
                          <a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/<?php echo propURL($property[0]['id_prop'], $langVal); ?>">
                            <?php if (file_exists($_SERVER["DOCUMENT_ROOT"] . '/media/images/properties/thumbnails/'.$property[0]['id_img'] .'_md.jpg')) { ?>
                                <img src="https://<?php echo $_SERVER['HTTP_HOST'] ?>/media/images/properties/thumbnails/<?php echo $property[0]['id_img'] ?>_md.jpg"  alt="" style="max-width:574px; width: 100%; height: auto; display: block;" width="574">
                            <?php } else { ?>
                                <img src="https://<?php echo $_SERVER['HTTP_HOST'] ?>/media/images/website/no-image.png" alt="" style="max-width:534px; width: 100%; height: auto;">
                            <?php } ?>
                          </a>
                        </td>
                      </tr>
