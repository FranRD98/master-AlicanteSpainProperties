    ...
    <a href="{$link}">
        ...
        <div class="marco-foto">
            {if $resource.img != ''}
                ...
                {imagesize src="{$imgProp}" width=840 height=420 class='img-fluid' alt="{$altt}" title="{$altt}" }
            {else}
                {imagesize src='/media/images/website/no-image.png' width=840 height=420 class='img-fluid' alt="{$altt}" title="{$altt}" }
            {/if}
        </div>
