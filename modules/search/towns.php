...
$_GET['lopr'] = sanitizeInput($_GET['lopr']);

require_once($_SERVER["DOCUMENT_ROOT"] . '/resources/lang_'.$_GET['lang'].'.php');

$ar = '';
if( isset($_GET['lopr']) && $_GET['lopr'] != '' && $_GET['lopr'] != 'null' ){
    $ar = " AND CASE WHEN properties_loc2.id_loc2 IS NOT NULL THEN properties_loc2.id_loc2 ELSE province1.id_loc2  END  IN (" . simpleSanitize((ltrim($_GET['lopr'])), ',') . ")";
}
