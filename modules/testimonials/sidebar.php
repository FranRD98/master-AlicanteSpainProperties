...
function getChilds($par, $slug, $level) {
    ...
    if ($categories[0]['id_ct'] != '') {
        ...
        foreach ($categories as $value) {
            ...
            $ret .= '<a class="list-group-item' . $active . '" ' . $active . ' href="'.$urlStart.''.$urlStr['news']['url'].'/'.$urlStr['category']['url'].'/'.$value['id_ct'].'/'.$theSlug.'">' . str_repeat("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", $levelmax) . '⊙⊙ ' . $value['cat'] . '</a>';
