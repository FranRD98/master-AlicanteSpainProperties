...
SELECT
    ...
    FROM news
    WHERE news.title_en_nws  != '' AND news.content_en_nws != '' AND type_nws = 4 AND activate_nws = 1
...
<channel>
    ...
    <atom:link href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/rss/rss_quicklinks.php" rel="self" type="application/rss+xml" />
...
<item>
    ...
    <link>https://<?php echo $_SERVER['HTTP_HOST']; ?>/<?php echo slug($row_rsProperties['titulo']) ?>.html</link>
    ...
    <guid isPermaLink="false">https://<?php echo $_SERVER['HTTP_HOST']; ?>/<?php echo slug($row_rsProperties['titulo']) ?>.html</guid>
    <description>
