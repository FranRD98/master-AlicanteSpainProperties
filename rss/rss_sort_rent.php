...
<channel>
    ...
    <atom:link href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/rss/rss_sort_rent.php" rel="self" type="application/rss+xml" />
...
<?php do { ?>
<item>
    <title><![CDATA[<?php echo ($row_rsProperties['partyp'] == null)?$row_rsProperties['types_en_typ']:$row_rsProperties['partyp']; ?> for sort term rental in <?php echo $row_rsProperties['partown']; ?>, <?php echo $row_rsProperties['province']; ?>]]></title>
