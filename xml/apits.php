...
<property>
    ...
    <desc>
        <?php if($row_rsProperties['descripcion_en_prop'] != '') { ?><en><![CDATA[  <?php echo str_replace('&amp;nbsp;', '',nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_en_prop'])))); ?> ]]></en><?php } ?>
        <?php if($row_rsProperties['descripcion_es_prop'] != '') { ?><es><![CDATA[ <?php echo str_replace('&amp;nbsp;', '',nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_es_prop'])))); ?> ]]></es><?php } ?>
        <?php if($row_rsProperties['descripcion_de_prop'] != '') { ?><de><![CDATA[ <?php echo str_replace('&amp;nbsp;', '',nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_de_prop'])))); ?> ]]></de><?php } ?>
        <?php if($row_rsProperties['descripcion_nl_prop'] != '') { ?><nl><![CDATA[ <?php echo str_replace('&amp;nbsp;', '',nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_nl_prop'])))); ?> ]]></nl><?php } ?>
        <?php if($row_rsProperties['descripcion_fr_prop'] != '') { ?><fr><![CDATA[ <?php echo str_replace('&amp;nbsp;', '',nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_fr_prop'])))); ?> ]]></fr><?php } ?>
        <?php if($row_rsProperties['descripcion_da_prop'] != '') { ?><da><![CDATA[ <?php echo str_replace('&amp;nbsp;', '',nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_da_prop'])))); ?> ]]></da><?php } ?>
        <?php if($row_rsProperties['descripcion_ru_prop'] != '') { ?><ru><![CDATA[ <?php echo str_replace('&amp;nbsp;', '',nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_ru_prop'])))); ?> ]]></ru><?php } ?>
    </desc>
    ...
    <?php } */?>
    <?php if(file_exists($_SERVER["DOCUMENT_ROOT"] . "/media/images/properties/thumbnails/".$row_rsImages['id_img']."_xl.jpg")) { ?>
        <image id="<?php echo $x++ ?>">
