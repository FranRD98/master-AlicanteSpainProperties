...
$query_rsXML = "SELECT * FROM xml_export WHERE uid_exp = '".mysqli_real_escape_string($inmoconn,$_GET['f'])."'";
...
WHERE properties_properties.activado_prop = 1 AND properties_properties.export_thinkspain_prop = 1 AND vendido_prop = 0 AND vendido_tag_prop = 0 AND reservado_prop = 0 AND alquilado_prop = 0
...
<property>
    ...
    <desc>
        ...
        <?php if($row_rsProperties['descripcion_de_prop'] != '') { ?><de><![CDATA[ <?php echo str_replace('<br />', '&#13;&#13;', nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_de_prop'])))); ?> ]]></de><?php } ?>
        <?php if($row_rsProperties['descripcion_nl_prop'] != '') { ?><nl><![CDATA[ <?php echo str_replace('<br />', '&#13;&#13;', nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_nl_prop'])))); ?> ]]></nl><?php } ?>
        <?php if($row_rsProperties['descripcion_fr_prop'] != '') { ?><fr><![CDATA[ <?php echo str_replace('<br />', '&#13;&#13;', nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_fr_prop'])))); ?> ]]></fr><?php } ?>
        <?php if($row_rsProperties['descripcion_da_prop'] != '') { ?><da><![CDATA[ <?php echo str_replace('<br />', '&#13;&#13;', nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_da_prop'])))); ?> ]]></da><?php } ?>
        <?php if($row_rsProperties['descripcion_ru_prop'] != '') { ?><ru><![CDATA[ <?php echo str_replace('<br />', '&#13;&#13;', nl2br(strip_tags(preg_replace('/&/', '&amp;', $row_rsProperties['descripcion_ru_prop'])))); ?> ]]></ru><?php } ?>
    </desc>
