...
//     $kyero = ' AND export_todopisoalicante_prop = 1 ';
// }
...
WHERE properties_properties.activado_prop = 1 AND properties_properties.export_todopisoalicante_prop = 1 AND vendido_prop = 0 AND vendido_tag_prop = 0 AND reservado_prop = 0 AND alquilado_prop = 0
